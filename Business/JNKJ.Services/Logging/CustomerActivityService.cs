...
namespace JNKJ.Services.Logging
{
    ...
    public class CustomerActivityService : ICustomerActivityService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string ACTIVITYTYPE_ALL_KEY = "JNKJ.activitytype.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ACTIVITYTYPE_PATTERN_KEY = "JNKJ.activitytype.";
        ...
        {
            if (activityLogTypeId == Guid.Empty)
                return null;
        ...
        public virtual IPagedList<ActivityLog> GetAllActivities(DateTime? createdOnFrom,
            DateTime? createdOnTo, Guid customerId, Guid activityLogTypeId,
        ...
        public virtual void ClearAllActivities()
        {
            ...
            {
                //although it's not a sited procedure we use it to ensure that a database supports them

...
namespace JNKJ.Services.Security
{
    public class EncryptionService : IEncryptionService
    {
        ...
        /// <returns></returns>
        public virtual string CreatePasswordMD5(string password, string saltkey)
        {
            byte[] b = Encoding.UTF8.GetBytes(password+saltkey);
        ...
        /// <returns></returns>
        public virtual string CreatePasswordSHA256(string str)
        {
